...
namespace DbPerfTest.Controllers
{
    ...
    public class PostgresPerfController : ControllerBase
    {
        private PostgresPerfTestContext _context;
        private readonly ILogger<PostgresPerfController> _logger;

        public PostgresPerfController(ILogger<PostgresPerfController> logger, PostgresPerfTestContext context)
        {
            _logger = logger;
            _context = context;
        }
